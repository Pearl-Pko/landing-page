...
export default function page() {
  return (
    <div className="pb-5 w-full">
      <NavBar />
      {/* <div> */}
        <div className="max-w-[1330px] h-auto w-full mx-auto  pt-[68px] ">
          <p className="bg-[#212426] py-2 font-semibold text-white inline px-5 rounded-full">
            No-Code WordPress Site Builder
          </p>
          <div className="flex justify-between gap-12 my-20 items-center">
            <div className="">
          ...
          <div className="grid grid-cols-3 gap-1 relative overflow-hidden">
            ...
            <div className="z-10 bg-[#17191a] p-12 rounded-2xl flex flex-col justify-end gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-secondary font-semibold text-lg">
                  Fewer external plugins mean fewer vulnerabilities, keeping
                  your site secure and lightweight.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative grid grid-cols-4 gap-[1px]">
            ...
            <div className="bg-[#17191a] p-8 rounded-2xl col-span-4 flex justify-between">
              <div className="flex-1 self-end ">
                <div className=" flex flex-col gap-6 max-w-[300px]">
                  ...
                  <p className="text-secondary font-semibold text-[16px]">
                    Migrate your existing design seamlessly into Droip with just
                    a click of a button!
                  </p>
                </div>
              </div>
              <Image
                ...
                className="flex-1"
                src={
                  "https://droip.com/wp-content/uploads/2025/03/design1.webp"
                }
                alt="image"
              />
            </div>
            <div className="col-span-2 flex flex-col gap-6 bg-[#17191a] p-8 rounded-2xl justify-between">
              <Image
                ...
                height={400}
                src={
                  "https://droip.com/wp-content/uploads/2025/03/design-1.webp"
                }
                alt="image"
              />
              <div className="flex flex-col gap-6 max-w-[300px]">
            ...
            <div className="col-span-2 flex flex-col gap-6 bg-[#17191a] p-8 rounded-2xl justify-between">
              <Image
                ...
                height={400}
                src={
                  "https://droip.com/wp-content/uploads/2025/03/design8.webp"
                }
                alt="image"
              />
              <div className="flex flex-col gap-6 max-w-[300px]">
            ...
            <div className="flex flex-col gap-6 bg-[#17191a] p-8 rounded-2xl justify-between">
              <Image
                ...
                height={400}
                src={
                  "https://droip.com/wp-content/uploads/2025/03/design2.webp"
                }
                alt="image"
              />
              <div className="flex flex-col gap-6 max-w-[300px]">
                ...
                <p className="text-secondary text-[16px] font-semibold">
                  Seamlessly import Figma designs into Droip and bring your
            ...
            <div className="flex flex-col gap-6 bg-[#17191a] p-8 rounded-2xl justify-between">
              <Image
                ...
                height={400}
                src={
                  "https://droip.com/wp-content/uploads/2025/03/design4.webp"
                }
                alt="image"
              />
              <div className="flex flex-col gap-6 max-w-[300px]">
                ...
                <p className="text-secondary text-[16px] font-semibold">
                  Add custom HTML, CSS, and JavaScript to an element for
            ...
            <div className="flex flex-col gap-6 bg-[#17191a] p-8 rounded-2xl justify-between">
              <Image
                ...
                height={400}
                src={
                  "https://droip.com/wp-content/uploads/2025/03/design6.webp"
                }
                alt="image"
              />
              <div className="flex flex-col gap-6 max-w-[300px]">
